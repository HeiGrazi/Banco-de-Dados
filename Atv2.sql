create database db_pizzaria_legal1;
 ...
 values
 ("Salgada","Brocolis",45.00,false,5),
 ("Salgada","Atum",48.00,true,5),
 ("Doce","Brigadeiro",50.00,true,1),
 ("Salgada","Queijo",51.00,false,2),
 ("Doce","MeM",30.00,false,4),
 ("Doce","Prestígio",50.00,false,4), 
 ("Salgada","Frango Catupiry",40.00,true,3),
 ("Salgada","Peperonni",55.00,false,2);
...
select * from tb_pizzas inner join tb_categorias on tb_pizzas.categoria_id = tb_categorias.id where tb_pizzas.sabor like "Brocolis";
